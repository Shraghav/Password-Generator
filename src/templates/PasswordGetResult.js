...
const PasswordGetResult = () => {
    ...
    return (
        ...
        <form onSubmit={getPassword} class="max-w-md mx-auto p-4 bg-white shadow-lg rounded-lg">
            <h4 className='pb-5'>Search your password</h4>
            ...
            <p>Provide the title to show the intended password</p>
